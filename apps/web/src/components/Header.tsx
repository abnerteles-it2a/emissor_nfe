    ...
    <header className="h-14 border-b border-slate-800 bg-[#020617]/90 px-6 flex items-center justify-between shrink-0 sticky top-0 z-30 shadow-sm">
      ...
      <div className="relative hidden md:block">
        ...
        <input
          ...
          className="w-64 bg-slate-900 border border-slate-800 rounded-lg pl-8 pr-3 py-1.5 text-xs text-white placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-teal-500"
        />
      </div>
