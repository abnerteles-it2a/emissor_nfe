      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-slate-900 border border-slate-800 p-4 rounded-xl">
        <div className="relative flex-1 max-w-md">
          ...
          <input
            ...
            className="w-full bg-slate-950 border border-slate-800 rounded-lg pl-9 pr-4 py-2 text-xs text-white placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-brand-500"
          />
        </div>
              ...
              {filteredDocs.length === 0 ? (
                ...
                filteredDocs.map((doc) => (
                  <tr key={doc.id} className="hover:bg-slate-800/40 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <span className="block font-medium text-slate-200 max-w-[220px] truncate" title={doc.recipientName}>
                        {doc.recipientName}
                      </span>
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="inline-flex items-center gap-1.5">
                        ...
                        <button
                          ...
                          className="p-1.5 rounded-lg bg-slate-800 text-slate-300 hover:bg-brand-600 hover:text-white transition-colors"
                        >
                        ...
                        {doc.status === 'AUTHORIZED' && doc.documentType === 'NFE' && (
                          <button
                            ...
                            className="p-1.5 rounded-lg bg-slate-800 text-amber-400 hover:bg-amber-500/20 transition-colors"
                          >
      ...
      {modalType === 'DANFE' && selectedDoc && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto p-6 shadow-2xl">
            ...
            <div className="mt-6 border border-slate-700 rounded-xl p-5 bg-slate-950 space-y-5 text-xs text-slate-300 font-sans">
              {/* Top Banner */}
              <div className="flex flex-col sm:flex-row justify-between items-start gap-4 pb-4 border-b border-slate-800">
                <div>
                  ...
                  <h4 className="font-bold text-white text-sm">IT2A SOLUCOES TECNOLOGICAS LTDA</h4>
                ...
                <div className="bg-slate-900 p-3 rounded-lg border border-slate-800 text-right">
                  ...
                  <span className="text-base font-bold text-white">Nº {selectedDoc.number}</span>
            ...
            <div className="flex justify-end gap-3 mt-6">
              <button
                ...
                className="px-4 py-2 rounded-lg text-xs font-semibold bg-slate-800 text-slate-200 hover:bg-slate-700 flex items-center gap-1.5"
              >
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-lg w-full p-6 shadow-2xl">
            <div className="flex items-center justify-between pb-4 border-b border-slate-800">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-white text-base">Carta de Correção Eletrônica (CC-e)</h3>
            ...
            <div className="mt-4 space-y-4 text-xs text-slate-300">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl p-3 text-white placeholder-slate-600 focus:outline-none focus:ring-1 focus:ring-amber-500"
                />
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-lg w-full p-6 shadow-2xl">
            <div className="flex items-center justify-between pb-4 border-b border-slate-800">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-white text-base">Cancelar Documento Fiscal</h3>
            ...
            <div className="mt-4 space-y-4 text-xs text-slate-300">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl p-3 text-white placeholder-slate-600 focus:outline-none focus:ring-1 focus:ring-rose-500"
                />
