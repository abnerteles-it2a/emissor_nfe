  ...
  return (
    <div className="space-y-8 max-w-5xl">
      ...
      <div className="pb-6 border-b border-slate-800">
        ...
        <h1 className="text-2xl font-bold tracking-tight text-white">Fechamento Fiscal & Exportação Contábil</h1>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-5 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-base font-bold text-white">Mês de Referência</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          <select
            ...
            className="bg-slate-950 border border-slate-800 focus:border-brand-500 rounded-lg px-4 py-2 text-xs text-white font-medium focus:outline-none"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-5 shadow-sm">
          ...
          <span className="text-2xl font-bold text-white block">18 XMLs</span>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-5 shadow-sm">
          ...
          <span className="text-2xl font-bold text-white block">2 Eventos</span>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-5 shadow-sm">
          ...
          <span className="text-2xl font-bold text-white block">12 XMLs</span>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 space-y-6">
        <div>
          <h2 className="text-base font-semibold text-white">Opções de Exportação para Contabilidade</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {/* Download Direto */}
          <div className="p-5 bg-slate-950/60 border border-slate-800 rounded-xl flex flex-col justify-between space-y-4">
            <div>
          ...
          <div className="p-5 bg-slate-950/60 border border-slate-800 rounded-xl flex flex-col justify-between space-y-4">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="flex-1 bg-slate-900 border border-slate-800 rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-brand-500"
              />
              <button
                type="button"
                onClick={handleSendEmail}
                className="inline-flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-semibold bg-slate-800 text-slate-200 hover:text-white hover:bg-slate-700 transition-colors border border-slate-700"
              >
